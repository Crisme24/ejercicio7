 ...
 * Pregunta
 *
 * @ORM\Table(name="pregunta", uniqueConstraints={@ORM\UniqueConstraint(name="id", columns={"id"})}, indexes={@ORM\Index(name="idbloque", columns={"idbloque"}), @ORM\Index(name="idencuesta", columns={"idencuesta"}), @ORM\Index(name="idtipo", columns={"idtipo"})})
 * @ORM\Entity
 */
class Pregunta
{
